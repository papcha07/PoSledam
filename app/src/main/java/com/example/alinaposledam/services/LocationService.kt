...
import com.example.alinaposledam.R
...
class LocationService : Service() {
    ...
    private fun start() {
        ...
        val notification = Notification.Builder(this, "location")
            ...
            .setContentText("Waiting for location...") // <-- вместо второго setContentTitle
        ...
        locationClient.getLocationUpdates(1000000L).catch { e ->
            e.printStackTrace()
        }.onEach { location ->
